...
export const routes: Routes = [
  ...
  },
  {
   ...
   {
    path: 'usage', loadComponent() {
      return import('./usage/usage.component').then(m => m.UsageComponent);
    },
  },
  {
    path: 'otp', loadComponent() {
      return import('./otpgeneration/otpgeneration.component').then(m => m.OtpgenerationComponent);
    },
  }
